...
addCommands(
    DRIVE,FORWARDS,900,0,TIMET,450,MMREGPID,60,127,ACCEL,
    ...
    DRIVE,FORWARDS,2900,1480,ACCEL,
    INTAKE,OUT,127,
...
addCommands(
    ...
    DRIVE,BACKWARDS,500,NOSTRAIGHT,INTAKET,2,50,NOPID,120
);
}
...
addCommands(
    ...
    DRIVE,FORWARDS,550,5,MMREGPID,60,127,ACCEL,
...
addCommands(
    INTAKE,OUT,90,
    INTAKE,OUT,0,TIMET,320,
    DRIVE,BACKWARDS,500,NOSTRAIGHT,INTAKET,2,70,NOPID,120
);}
