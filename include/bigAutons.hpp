...
addCommands(
    ...
    DRIVE,FORWARDS,390,0,MMREGPID,55,127,REGACCEL,NOBRAKE,TIMET,1000,
    DRIVE,FORWARDS,460,0,NOPID,50,
    DRIVE,TURN,3060,NOSTRAIGHT,TURNPID,
    DRIVE,BACKWARDS,900,3060,REGACCEL,
    DRIVE,TURN,0,NOSTRAIGHT,TURNPID,
    DRIVE,FORWARDS,150,0,MMREGPID,55,100,REGACCEL,NOBRAKE,
    DRIVE,FORWARDS,650,0,NOPID,53,NOBRAKE, //940
    DRIVE,UPLEFTSWEEP,650,2800,NOSTRAIGHT,NOPID,65,
    DRIVE,BACKWARDS,700,3400,
    DRIVE,TURN,1370,NOSTRAIGHT,TURNPID2,
    DRIVE,FORWARDS,400,1430,REGACCEL,NOBRAKE,MMREGPID,50,127,
    DRIVE,FORWARDSE,50,1430,TIMETE,350,
    ...
    TILTER,POSITION,1750,127,DRIVET,10,200,
    TILTER,POSITION,900,127,DRIVET,12,0
    );
addCommands(
    INTAKE,OUT,0,
    INTAKE,OUT,45,TILTERT,1,1900,
    INTAKE,OUT,0,TILTERT,1,3100,
    TILTER,POSITION,5700,127,
    TILTER,POSITION,6200,90
    );
addCommands(
    INTAKE,OUT,78,
