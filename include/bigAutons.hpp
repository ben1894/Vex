...
addCommands(
    ...
    DRIVE,FORWARDS,300,5,MMREGPID,60,127,REGACCEL,NOBRAKE,
    DRIVE,FORWARDS,2100,5,NOPID,49,
    DRIVE,TURN,2100,NOSTRAIGHT,TURNPID2,
    DRIVE,FORWARDS,2270,NOSTRAIGHT,REGACCEL,TIMET,200,
    INTAKE,OUT,127,
    INTAKE,IN,127,TIMET,200,
    INTAKE,IN,50,DRIVET,9,600,
...
addCommands(
    ...
    DRIVE,BACKWARDS,500,NOSTRAIGHT,TIMET,300,NOPID,60,
