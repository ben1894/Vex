...
addCommands(
    ...
    DRIVE,TURN,3585,NOSTRAIGHT,TURNPID,
    DRIVE,FORWARDS,150,3585,MMREGPID,55,100,REGACCEL,NOBRAKE,
    DRIVE,FORWARDS,1390,3585,NOPID,48, //940
    DRIVE,BACKWARDS,910,3585,
    DRIVE,TURN,1320,NOSTRAIGHT,TURNPID2,
    DRIVE,FORWARDS,400,1380,REGACCEL,NOBRAKE,MMREGPID,50,127,
    DRIVE,FORWARDSE,55,1380,TIMETE,300,
...
addCommands(
    ...
    DRIVE,FORWARDS,1390,20,NOPID,48, //940
    DRIVE,BACKWARDS,910,20,
    DRIVE,TURN,2280,NOSTRAIGHT,TURNPID2,
    DRIVE,FORWARDS,400,2220,REGACCEL,NOBRAKE,MMREGPID,50,127,
    DRIVE,FORWARDSE,55,2220,TIMETE,300,
    INTAKE,OUT,127,LIFTT,1,1500,
    INTAKE,IN,127,TIMET,700,
    INTAKE,IN,45,DRIVET,9,15,
    TILTER,POSITION,2000,127,DRIVET,9,10
