...
addCommands(
    ...
    DRIVE,FORWARDS,2500,3570,NOPID,43,
...
addCommands(
    ...
    DRIVE,FORWARDS,550,30,MMREGPID,60,127,
    DRIVE,FORWARDS,2500,30,NOPID,43,
    DRIVE,TURN,2120,NOSTRAIGHT,TURNPID,
    DRIVE,FORWARDS,2900,2120,
    INTAKE,OUT,127,
    INTAKE,IN,127,TIMET,200,
    INTAKE,IN,0,DRIVET,9,0,
    INTAKE,OUT,50,DRIVET,9,2300,
