...
void bigBlue()
{
    resetAutonVals();
addCommands(
    LIFT,POSITION,1000,127,
    LIFT,SPEED,-100,TIMETE,200,
    DRIVE,FORWARDS,490,0,MMREGPID,69,127,REGACCEL,NOBRAKE,TIMET,1000,
    DRIVE,FORWARDS,1000,0,NOPID,44,
    DRIVE,TURN,310,NOPID,TURNPID,
    DRIVE,BACKWARDS,1490,310,REGACCEL,
    DRIVE,TURN,0,NOSTRAIGHT,TURNPID,
    DRIVE,FORWARDS,150,0,MMREGPID,55,100,REGACCEL,NOBRAKE,
    DRIVE,FORWARDS,1220,0,NOPID,44,
    DRIVE,TURN,2150,NOSTRAIGHT,TURNPID2,
    DRIVE,FORWARDS,1200,2090,REGACCEL,
    INTAKE,OUT,127,LIFTT,1,400,
    INTAKE,IN,127,TIMET,1500,
    INTAKE,IN,127,DRIVET,7,10000,
    INTAKE,IN,0,TIMET,420,
    TILTER,POSITION,(int)fabs(tilter.get_position()),127,DRIVET,7,100000,
    TILTER,POSITION,2000,120,TIMET,700
    //INTAKE,OUT,80,DRIVET,10,1200
    );
addCommands(
...
addCommands(
    INTAKE,OUT,127,
    INTAKE,IN,0,TIMET,1000,
    DRIVE,BACKWARDS,294,NOSTRAIGHT,TIMET,200,NOPID,127,
    TILTER,POSITION,5000,127,TIMET,300
);
}
