...
addCommands(
    ...
    DRIVE,FORWARDS,50,0,MMREGPID,45,127,REGACCEL,NOBRAKE,TIMET,1500,
    DRIVE,FORWARDS,800,0,NOPID,45,
    DRIVE,TURN,520,NOSTRAIGHT,TURNPID,
    DRIVE,BACKWARDS,970,520,REGACCEL,
    DRIVE,TURN,0,NOSTRAIGHT,TURNPID,
    DRIVE,FORWARDS,150,0,MMREGPID,50,100,REGACCEL,NOBRAKE,
    DRIVE,FORWARDS,890,0,NOPID,54, //940
    DRIVE,BACKWARDS,550,0,
    DRIVE,TURN,2330,NOSTRAIGHT,TURNPID2,
    DRIVE,FORWARDS,400,2270,REGACCEL,NOBRAKE,MMREGPID,48,127,
    DRIVE,FORWARDSE,40,2270,TIMETE,350,
...
addCommands(
    ...
    DRIVE,TURN,0,NOSTRAIGHT,TURNPID,
    DRIVE,FORWARDS,150,0,MMREGPID,50,100,REGACCEL,NOBRAKE,
    DRIVE,FORWARDS,890,0,NOPID,53, //940
